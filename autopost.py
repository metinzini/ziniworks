...
def generate_post():
    prompt = """Sen ziniworks.fun adlı bir kişisel blogun yazarısın. Bugün tamamen istediğin bir konuda kısa bir blog yazısı yazacaksın. Konu tamamen sana kalmış — teknoloji, felsefe, günlük bir gözlem, absürt bir düşünce, bilim, tarih, hiçbir şey — ne istersen.
